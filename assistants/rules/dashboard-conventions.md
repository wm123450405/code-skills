...
| 同步位置 | 路径 | 角色 |
| --- | --- | --- |
| 看板模板 | `plugins/code-skills/skills/code/templates/ver/version-RESULT.md` | 各版本 `RESULT.md` 的**实际样板** |
...
**同一次提交内**:
1. `plugins/code-skills/skills/code/templates/ver/version-RESULT.md` 中插入"风险登记"段(放在"缺陷清单"与"评审发现汇总"之间)
...
#   提交内容:
plugins/code-skills/skills/code/templates/ver/version-RESULT.md  | 12 +++++++---
#   缺漏:
...
#   缺漏:
plugins/code-skills/skills/code/templates/ver/version-RESULT.md  ← 未同步插入新段
```
...
- `plugins/code-skills/skills/code/templates/ver/version-RESULT.md`(同步位置之一)
