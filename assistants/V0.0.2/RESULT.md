...
| `TASK-REQ-00010-00001` | REQ-00010 | 修改 | 详细设计 | [修改] 增量追加 `code-it/SKILL.md`(锚点 A:§"标题解析(REQ-00013 新增)" 小节**后** + §"工作流程" 小节**前**,插入"## 步骤 0a — 前置任务守卫"小节,含 5 主子节 + 1 退化条件子节;锚点 B:既有"边界 E-1" 后插 E-2 守卫不通过 + E-10 标题解析失败;INV-1~12 字节级保留;frontmatter 字节级保留;复用 REQ-00013 标题解析工具函数 5 个) | 待开始 | 不适用 | `plugins/code-skills/skills/code-it/SKILL.md`(预估净增 ~100 行) | — | — | — |
