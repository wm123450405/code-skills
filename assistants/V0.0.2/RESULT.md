...
| M1-REQ-00015-1:本需求可发布 | T-001 ~ T-005(REQ-00015) | 5 任务开发状态=已完成 且 测试状态=不适用 + 10 项 INV-1~10 100% 自检通过 + 看板 6 处一致 + 0 触发 `dashboard-conventions §规则 1` 3 处同步 + 0 派生"更新看板"任务 REQ-00017 强约束 + 0 修改其他 11 个 `code-*` SKILL.md + 0 修改 plugin.json + 0 新增三方依赖 + 0 实现 v1 follow-up | 待开始 | 2026-06-06 | — |
