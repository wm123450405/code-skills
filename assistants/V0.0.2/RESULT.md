...
| M1-REQ-00008-1:文档就绪 | T-001(REQ-00008) | 1 个 SKILL.md 增量追加完成(2 段:锚点 A L109 后 + 锚点 B L313 后)+ INV-1/4/11/12 字节级保留 + 13/13 INV 自检通过(由 T-003 收尾执行) | 待开始 | 2026-06-05 | — |
| M1-REQ-00008-2:本需求可发布 | M1-REQ-00008-1 + T-002 + T-003(REQ-00008) | **3 任务开发状态=已完成 且 测试状态=不适用**,13/13 INV 100% 自检通过 + 看板 5 处一致 + 未来 `code-review`(无参)可触发 | 待开始 | 2026-06-05 | — |
...
| REQ-00008 | `/code-review` 整版本模式(无参评审:增量改 SKILL.md + 0 新增 + 4 复用 + 3 任务 + 13/13 INV) | **已完成(详细设计)** | 3 | 0 | 0 | 2026-06-05 16:00 | [PLAN.md](plan/REQ-00008/PLAN.md) / [RESULT.md](plan/REQ-00008/RESULT.md) |
...
**统计**:5 个计划 / 共 23 个任务 / **开发完成 16 ✅** / 测试通过 0 / **真正可发布 16 / 23**
...
| `TASK-REQ-00008-00001` | REQ-00008 | 修改 | 需求新增 | [修改] 增量追加 `code-review/SKILL.md`(2 段:步骤 1.5 模式选择 + 步骤 2 整版本模式 + 步骤 3 退化 + 整版本模式附录;锚点 A L109 后 + 锚点 B L313 后) | 待开始 | 不适用 | `plugins/code-skills/skills/code-review/SKILL.md`(+60 ~ +120 行) | — | — | — |
| `TASK-REQ-00008-00002` | REQ-00008 | 文档 | 需求新增 | [文档] 同步 V0.0.2 看板 5 处(详细设计与任务计划汇总 + 任务清单 3 行 + 里程碑 2 个 + 文档头 + 变更记录) | 待开始 | 不适用 | `assistants/V0.0.2/RESULT.md` | T-001 | — | — |
| `TASK-REQ-00008-00003` | REQ-00008 | 文档 | 需求新增 | [文档] 13 项不变量自检(INV-1~13)+ 偏差日志 + 收尾 | 待开始 | 不适用 | `code/TASK-REQ-00008-00003/{RESULT,work-log,deviations}.md` | T-001, T-002 | — | — |
...
**统计**:
- 总任务数:18
- 真正可发布数(开发=已完成 ∧ 测试∈{已运行-通过, 不适用}):18 / 18 ✅
- 开发已完成 / 未完成:18 / 0
