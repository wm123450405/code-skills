...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `TASK-REQ-00010-00001` | 修改 | 详细设计 | [修改] 增量追加 `code-it/SKILL.md`(锚点 A:"## 标题解析"段后 + "## 工作流程"段前,插入"## 步骤 0a — 前置任务守卫"小节,含 5 子节 + 10 项边界场景;INV-1~9 字节级保留;frontmatter 字节级保留;INV-10/11/12 自检;锚点 A 严格在既有 §"标题解析" 小节**后**,沿用 REQ-00013 标题解析追加模式) | 待开始 | 不适用 | `plugins/code-skills/skills/code-it/SKILL.md`(预估净增 ~100 行) | — | — | — |
