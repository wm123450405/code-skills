...
| --- | --- | --- | --- | --- | --- | --- | --- |
| TASK-REQ-00012-00001 | REQ-00012 | 文档 | 详细设计 | 创建仓库根 README.md(中文,< 50 行) | 待开始 | 不适用 | `./README.md` |
| TASK-REQ-00012-00002 | REQ-00012 | 文档 | 详细设计 | 创建仓库根 README.en.md(英文,< 50 行,与 T-001 同次提交) | 待开始 | 不适用 | `./README.en.md` |
