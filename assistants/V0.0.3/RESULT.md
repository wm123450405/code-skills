...
| BUG-00002 | P0 | SKILL.md 描述中"特定文件类型"字面(`skills/*/SKILL.md` / `tests/` / `*.test.*`)违反本项目"通用开发技能集"定位 | 调查中 | 2026-06-08 14:00 | — | — | — |
| BUG-00003 | P0 | SKILL.md 描述中"绝对路径"(`plugins/code-skills/...`)在 plugin 安装后断链 | 调查中 | 2026-06-08 14:10 | — | — | — |

**统计**:3 / P0: 3 / P1: 0 / P2: 0 / 已修复 0 / 待修复 3 / 修复规划中 0 / 修复编码中 1 / 调查中 2 / 报告 0
...
**统计**:23 / 必须改: 0(全部沿用既有"必须改"已含 + F-022 / F-023 评审通过 0 必须改) / 建议改: 4 / 可选: 13 / 已处理: 0 / 评审中: 2(F-022, F-023)
...
| 2026-06-08 14:00 | 缺陷状态 | BUG-00002 状态"报告"→"调查中"(登记 9 处"特定文件类型"字面波及范围) | BUG-00002 |
