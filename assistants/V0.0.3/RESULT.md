...
- 最近更新:2026-06-16 17:33(REQ-00036 T-1 扫描完成)
- 创建人:wangmiao
- 负责人:wangmiao
- 状态:活跃
...
| TASK-REQ-00036-00002 | REQ-00036 | 文档 | 详细设计 | [文档] 应用 6 条清理规则(R-1 ~ R-6)到 T-1 清单,原地改写 + diff 校验 + 残缺回退 | 待开始 | 不适用 | 同 T-1(47 文件) | — | — | — |
| TASK-REQ-00036-00003 | REQ-00036 | 文档 | 详细设计 | [文档] 跑 AC-1 ~ AC-8 验证 + 1 次 commit + 看板同步 + 末尾兜底 | 待开始 | 不适用 | assistants/V0.0.3/RESULT.md + git 仓库 | — | — | — |

**统计**:
- 总任务数:84
- 真正可发布数(开发=已完成 ∧ 测试∈{已运行-通过, 不适用}):76
- 开发已完成 / 未完成:76 / 8
