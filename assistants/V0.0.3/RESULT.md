...
- 最近更新:2026-06-16 17:33(REQ-00036 详细设计与编码计划完成)
- 创建人:wangmiao
- 负责人:wangmiao
- 状态:活跃
...
**统计**:17 个计划 / 共 92 个任务 / 开发完成 51 / 测试通过 0(不适用 92)
...
| TASK-REQ-00036-00001 | REQ-00036 | 文档 | 详细设计 | [文档] 扫描并产出 14 技能 SKILL.md + templates/ 待清理文件表与命中计数基线 | 待开始 | 不适用 | plugins/code-skills/skills/*/{SKILL.md, templates/*.md}(37 文件) | — | — | — |
| TASK-REQ-00036-00002 | REQ-00036 | 文档 | 详细设计 | [文档] 应用 6 条清理规则(R-1 ~ R-6)到 T-1 清单,原地改写 + diff 校验 + 残缺回退 | 待开始 | 不适用 | 同 T-1(37 文件) | — | — | — |
| TASK-REQ-00036-00003 | REQ-00036 | 文档 | 详细设计 | [文档] 跑 AC-1 ~ AC-8 验证 + 1 次 commit + 看板同步 + 末尾兜底 | 待开始 | 不适用 | assistants/V0.0.3/RESULT.md + git 仓库 | — | — | — |

**统计**:
- 总任务数:84
- 真正可发布数(开发=已完成 ∧ 测试∈{已运行-通过, 不适用}):75
- 开发已完成 / 未完成:75 / 9
