...
| REQ-00021 | 优化 3 技能 --result / --plan 模板参数,按用户模板格式输出填充后文档 | 已完成 | 2026-06-06 | 2026-06-06 | [REQ-00021/RESULT.md](./require/REQ-00021/RESULT.md) | — | — |
...
**统计**:1 个计划 / 共 6 个任务 / 开发完成 6 / 测试通过 0(不适用 6)
