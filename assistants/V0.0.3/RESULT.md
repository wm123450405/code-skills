...
| TASK-REQ-00023-00001 | REQ-00023 | 修改 | 详细设计 | [修改] 段 1 总开发进度计算函数(算法 1) | 待开始 | 不适用 | plugins/code-skills/skills/code-dashboard/SKILL.md §输出 段 1 + §工作流程 步骤 4 段 1 | — | — | — |
| TASK-REQ-00023-00002 | REQ-00023 | 修改 | 详细设计 | [修改] 5 类状态判定函数(算法 2) | 待开始 | 不适用 | plugins/code-skills/skills/code-dashboard/SKILL.md §工作流程 步骤 4 段 2 | — | — | — |
| TASK-REQ-00023-00003 | REQ-00023 | 修改 | 详细设计 | [修改] 5 类状态计数函数(算法 3) | 待开始 | 不适用 | plugins/code-skills/skills/code-dashboard/SKILL.md §工作流程 步骤 4 段 2 | — | — | — |
| TASK-REQ-00023-00004 | REQ-00023 | 修改 | 详细设计 | [修改] 后续操作建议生成(算法 4) | 待开始 | 不适用 | plugins/code-skills/skills/code-dashboard/SKILL.md §工作流程 步骤 4 段 4 + §附录 C | — | — | — |
| TASK-REQ-00023-00005 | REQ-00023 | 修改 | 详细设计 | [修改] 高优先级缺陷段保留 + 边界 E-1 ~ E-10 | 待开始 | 不适用 | plugins/code-skills/skills/code-dashboard/SKILL.md §工作流程 步骤 4 段 3 + §边界与异常 | — | — | — |
| TASK-REQ-00023-00006 | REQ-00023 | 修改 | 详细设计 | [修改] 输出区段与衔接小节改造 + 变更记录 | 待开始 | 不适用 | plugins/code-skills/skills/code-dashboard/SKILL.md §输出 + §衔接 + §变更记录 | — | — | — |

**统计**:
- 总任务数:30
- 真正可发布数(开发=已完成 ∧ 测试∈{已运行-通过, 不适用}):24
- 开发已完成 / 未完成:24 / 6
- 测试已通过 / 已失败 / 不适用 / 未编写:0 / 0 / 24 / 6
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| BUG-00001 | P0 | code-require/code-design/code-plan... | 报告 | 2026-06-06 22:41 | — | — | — |

**统计**:1 / P0: 1 / P1: 0 / P2: 0 / 已修复 0 / 待修复 1
