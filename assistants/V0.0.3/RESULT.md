...
- 最近更新:2026-06-22 15:00(代码计划 BUG-00005 完成,看板 §"任务清单"追加 3 行 + §"缺陷清单" BUG-00005 状态 报告 → 修复规划中 + §"变更记录"追加 1 条 + §统计 100 → 103)
- 创建人:wangmiao
- 负责人:wangmiao
- 状态:活跃
...
| TASK-BUG-00005-00001 | BUG-00005 | 修改 | 缺陷修复 | [修改] code-require 步骤 7A 添加技术选型过滤器 | 待开始 | 不适用 | plugins/code-skills/skills/code-require/SKILL.md §步骤 7A(L322-333) | — | — | — | BUG-00005 | — | — |
