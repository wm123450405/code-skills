...
- 最近更新:2026-06-22 16:35(REQ-00039 评审完成,派生 1 个审查改修任务 T-006)
- 创建人:wangmiao
- 负责人:wangmiao
- 状态:活跃
...
| REQ-00038 | 优化 /code-it 技能单测判定(从工程粒度细化到模块粒度:模块识别优先级链 + 模块级守卫 7 项 + 模块级单测输出 + 模板多模块支持) | 草稿 | 2026-06-22 | — | [REQ-00038/RESULT.md](./require/REQ-00038/RESULT.md) | — | — |
...
| TASK-REQ-00039-00006 | REQ-00039 | 修改 | 审查改修 | [修改] 修正 T-2 / T-3 / T-4 评审发现(合并 1 必须改 + 2 建议改) | 待开始 | 未编写 | code-it/templates/RESULT.md + code-it/SKILL.md + code-check/SKILL.md | — | — | T-2, T-3, T-4 |

**统计**:
- 总任务数:90
- 真正可发布数(开发=已完成 ∧ 测试∈{已运行-通过, 不适用}):86
- 开发已完成 / 未完成:86 / 4
- 测试已通过 / 已失败 / 不适用 / 未编写:0 / 0 / 89 / 1
...
| F-034 | REQ-00039 | TASK-REQ-00039-00004 | 正确性 | 必须改 | 模板"## 10. 逻辑行统计(由 code-it 内化,新增,"小节标题末尾有未闭合的半角逗号 `,`(line 124) | TASK-REQ-00039-00006 | 待处理 |
| F-035 | REQ-00039 | TASK-REQ-00039-00002 | 一致性 | 建议改 | 步骤 8.6.3 E-3 字面与 `logic-loc.md` §函数 2 错误处理字面基本一致但任务级 vs 函数级职责混淆;建议追加"任务级继续下一文件"字面 | TASK-REQ-00039-00006 | 待处理 |
| F-036 | REQ-00039 | TASK-REQ-00039-00003 | 一致性 | 建议改 | 步骤 8.13 "总规模优先,新增次之" 字面描述与 `logic-loc.md` §函数 4 算法字面有出入;建议改为"先判 totalLoc,再判 newLoc(两个独立发现,可同时触发)" | TASK-REQ-00039-00006 | 待处理 |

**统计**:36 / 必须改: 0(8 个必须改 F-024 ~ F-030 / F-034 全部 已处理 / F-034 待处理) / 建议改: 8 / 可选: 13 / 已处理: 7 / 评审中: 0 / 待处理: 4 (F-003 / F-004 / F-005 / F-006 / F-031 / F-032 / F-034 / F-035 / F-036 = 9)
...
| TASK-REQ-00039-00006 · [修改] 修正 T-2 / T-3 / T-4 评审发现(合并 1 必须改 + 2 建议改) | TASK-REQ-00039-00002, TASK-REQ-00039-00003, TASK-REQ-00039-00004 | 2026-06-22 16:35 | [REVIEW-REPORT.md](./review/REQ-00039/REVIEW-REPORT.md) | 待开始 |
