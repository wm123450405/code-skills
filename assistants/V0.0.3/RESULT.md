...
| BUG-00002 | P0 | SKILL.md 描述中"特定文件类型"字面(`skills/*/SKILL.md` / `tests/` / `*.test.*`)违反本项目"通用开发技能集"定位 | 修复规划中 | 2026-06-08 14:00 | — | — | — |
| BUG-00003 | P0 | SKILL.md 描述中"绝对路径"(`plugins/code-skills/...`)在 plugin 安装后断链 | 调查中 | 2026-06-08 14:10 | — | — | — |

**统计**:3 / P0: 3 / P1: 0 / P2: 0 / 已修复 0 / 待修复 3 / 修复规划中 1 / 修复编码中 1 / 调查中 1 / 报告 0
