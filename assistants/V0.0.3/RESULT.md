...
- 最近更新:2026-06-22 09:28(REQ-00037 详细设计与编码计划完成)
- 创建人:wangmiao
- 负责人:wangmiao
- 状态:活跃
...
| TASK-REQ-00037-00001 | REQ-00037 | 修改 | 详细设计 | [修改] code-fix 步骤 4/6 + 衔接 + 不要做的事同步 | 待开始 | 不适用 | plugins/code-skills/skills/code-fix/SKILL.md | — | — | — |
| TASK-REQ-00037-00002 | REQ-00037 | 修改 | 详细设计 | [修改] code-plan 步骤 27A/28A 末尾追加状态回写 | 待开始 | 不适用 | plugins/code-skills/skills/code-plan/SKILL.md §缺陷分支 步骤 27A/28A | — | — | T-1 |
| TASK-REQ-00037-00003 | REQ-00037 | 修改 | 详细设计 | [修改] code-it 步骤 21 末尾追加状态回写:开发中 | 待开始 | 不适用 | plugins/code-skills/skills/code-it/SKILL.md §缺陷分支 步骤 21 | — | — | T-1 |
| TASK-REQ-00037-00004 | REQ-00037 | 修改 | 详细设计 | [修改] code-it 步骤 24 末尾追加状态回写:待审查 | 待开始 | 不适用 | plugins/code-skills/skills/code-it/SKILL.md §缺陷分支 步骤 24 | — | — | T-1 |
| TASK-REQ-00037-00005 | REQ-00037 | 修改 | 详细设计 | [修改] code-check 步骤 1.5 BUG-NNN 识别 + 步骤 13 状态回写 | 待开始 | 不适用 | plugins/code-skills/skills/code-check/SKILL.md §步骤 1.5 / 步骤 13 | — | — | T-1 |
| TASK-REQ-00037-00006 | REQ-00037 | 修改 | 详细设计 | [修改] code-dashboard 步骤 4 段 3 扩展待修复/已修复分类 | 待开始 | 不适用 | plugins/code-skills/skills/code-dashboard/SKILL.md §步骤 4 段 3 | — | — | T-1 |
| TASK-REQ-00037-00007 | REQ-00037 | 文档 | 详细设计 | [文档] 端到端验证 AC-1 ~ AC-10 + 末尾兜底提交 | 待开始 | 不适用 | (无生产代码改动) | — | — | T-1 ~ T-6 |

**统计**:
- 总任务数:84
- 真正可发布数(开发=已完成 ∧ 测试∈{已运行-通过, 不适用}):77
- 开发已完成 / 未完成:77 / 7
...
**统计**:32 / 必须改: 0(7 个必须改 F-024 ~ F-030 全部 已处理) / 建议改: 6 / 可选: 13 / 已处理: 7 / 评审中: 0
