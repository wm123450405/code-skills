...
- 最近更新:2026-06-12 15:35(REQ-00031 详细设计与计划完成)
- 创建人:wangmiao
- 负责人:wangmiao
- 状态:活跃
...
| M1-REQ-00031 | REQ-00031 T-001 ~ T-005(5 任务,5 个被改文件) | 5 任务开发=已完成 ∧ 测试=不适用;INV-1~INV-10 全部满足;0 单列"编译运行检测"任务(本就是冗余);0 单元测试任务(主动外移) | 待开始 | 2026-06-12 | — |
...
**统计**:11 个计划 / 共 60 个任务 / 开发完成 50 / 测试通过 0(不适用 60)
...
| TASK-REQ-00031-00001 | REQ-00031 | 修改 | 详细设计 | [修改] code-plan/SKILL.md:任务粒度原则内化编译/运行 + 移除测试类型 + 收窄测试状态枚举 | 待开始 | 不适用 | plugins/code-skills/skills/code-plan/SKILL.md §步骤 10A | — | — | — |
| TASK-REQ-00031-00002 | REQ-00031 | 修改 | 详细设计 | [修改] code-it/SKILL.md:文档头 ## 目标 追加"不含单元测试"职责声明 | 待开始 | 不适用 | plugins/code-skills/skills/code-it/SKILL.md ## 目标 | — | — | — |
| TASK-REQ-00031-00003 | REQ-00031 | 修改 | 详细设计 | [修改] code-unit/SKILL.md:文档头 ## 目标 追加"独立、可选"职责声明 | 待开始 | 不适用 | plugins/code-skills/skills/code-unit/SKILL.md ## 目标 | — | — | — |
| TASK-REQ-00031-00004 | REQ-00031 | 修改 | 详细设计 | [修改] code-auto/SKILL.md:任务循环步骤 4.b 改为"恒等跳过" | 待开始 | 不适用 | plugins/code-skills/skills/code-auto/SKILL.md §步骤 4 任务循环 | — | — | — |
...
**统计**:
- 总任务数:73
- 真正可发布数(开发=已完成 ∧ 测试∈{已运行-通过, 不适用}):67
- 开发已完成 / 未完成:67 / 1
