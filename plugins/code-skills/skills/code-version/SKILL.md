...
- 在多个并行版本之间切换
- 归档/回看某个历史版本的完整状态
- 任何 `code-require` / `code-design` / `code-plan` / `code-it` / `code-unit` / `code-check` 调用前,先确认/切换当前工作空间
