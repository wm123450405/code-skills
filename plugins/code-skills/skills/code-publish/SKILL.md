...
- **模板**(本技能自带,在同技能 `templates/` 子目录):
  - `plugins/code-skills/skills/code-publish/templates/DEPLOY.md`
  - `plugins/code-skills/skills/code-publish/templates/UPDATE.md`
  - `plugins/code-skills/skills/code-publish/templates/Q&A.md`
  - `plugins/code-skills/skills/code-publish/templates/qanda-README.md`
  - `plugins/code-skills/skills/code-publish/templates/assistants-layout.md`
