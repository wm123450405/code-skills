...
**8.10 详设完整性**(本需求 REQ-00030 FR-7 校验点 1 新增,2026-06-12 起生效)
...
**8.11 概设越界检测**(本需求 REQ-00030 FR-7 校验点 2 新增,2026-06-12 起生效)
- `design/.../RESULT.md` §7 / §8 / §9 不应出现"完整字段类型 / 完整错误码 / 完整约束 / 完整索引"等详设深度内容
- 触发的正则模式(本需求 REQ-00030 锁定):
...
**8.12 行数比例警告**(本需求 REQ-00030 FR-7 校验点 3 新增,2026-06-12 起生效)
- `design/.../RESULT.md` 行数 / `plan/.../RESULT.md` 行数 **> 1.2** → 标黄警告(`design > plan * 1.2` 通常意味着概设"过深")
- 阈值 = 1.2(本需求 REQ-00030 锁定)
